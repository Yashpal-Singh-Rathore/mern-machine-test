...
export const uploadAndDistribute = async (req, res) => {
  ...
  if (!agents.length) {
    throw new AppError("No agents available", 400);
  }
  ...
  // 4. Save to DB ( only this part needs try/catch for transformation)
  try {
    ...
    throw error; // let express-async-errors forward it
  }
